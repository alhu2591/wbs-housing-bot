...
from .vonovia            import scrape as scrape_vonovia
from .gesobau            import scrape as scrape_gesobau
from .wbm                import scrape as scrape_wbm
...
ALL_SCRAPERS = [
    scrape_gewobag, scrape_degewo, scrape_howoge, scrape_stadtundland,
    scrape_deutschewohnen, scrape_berlinovo, scrape_vonovia,
    scrape_gesobau, scrape_wbm,
    scrape_immoscout, scrape_wggesucht, scrape_kleinanzeigen, scrape_immowelt,
]
